...
class I2VGenXLUNet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        # Define the shape prediction head
        # The shape prediction head needs to be defined outside
        self.shape_prediction_head = None
    ...
    def forward(
        ...
        # TODO: Add a lightweight shape prediction head here
        if self.shape_prediction_head is not None:
            up_block_out_feats = sample
            predicted_shape = self.shape_prediction_head(up_block_out_feats)
