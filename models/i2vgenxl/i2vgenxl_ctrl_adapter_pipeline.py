...
class I2VGenXLControlNetAdapterPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        self.controlnet_text_encoder = controlnet_text_encoder
        self.controlnet_tokenizer = controlnet_tokenizer
    ...
    def __call__(
        ...
        # Encode text prompt for I2VGenXL
        ...
        # Encode text prompt for ControlNet
        (
            ...
            negative_prompt_embeds=None,
            clip_skip=None,
            text_encoder=self.controlnet_text_encoder,
            tokenizer=self.controlnet_tokenizer,
        )

        # Prepare images for ControlNet
        ...
        # Encode image prompt for I2VGenXL
        # Image encodings
        ...
        # Prepare additional conditions for the UNet
        if self.do_classifier_free_guidance:
